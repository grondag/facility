...
import static grondag.brocade.painting.TextureLayout.*;
...
public abstract class TextureLayoutHelper {
    public static final TextureLayoutHelper BORDER_13_HELPER;
    ...
    static {
        ...
        BORDER_13_HELPER = new TextureLayoutHelper() {
            @Override
            public final String buildTextureName(TextureSet texture, int version, int index) {
        ...
        HELPERS[BORDER_13.ordinal()] = BORDER_13_HELPER;
