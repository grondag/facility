...
public class CornerJoinBlockStateSelector {
    ...
    public static <V> int findIndex(NeighborBlocks<V>.NeighborTestResults tests) {
    ...
    private <V> int getIndexFromNeighbors(NeighborBlocks<V>.NeighborTestResults tests) {
        int index = 0;
        int shift = 1;
        for (int i = 0; i < 6; i++) {
