...
public class TankBlockRenderer extends StorageBlockRenderer<TankBlockEntity> {
	...
	public TankBlockRenderer(BlockEntityRenderDispatcher blockEntityRenderDispatcher, int divisionLevel) {
	...
	protected void renderInner(TankBlockEntity bin, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int lightmap, int overlay) {
		//		final TankClientState renderState = bin.clientState();
		//
		...
		//		}
		//
		//		final Sprite[] sprites = renderState.renderSprites;
		//
		//		if(sprites == null) {
		//			return;
		//		}
		...
		//
		//		if (divisionLevel == 1) {
		//			renderFront1(sprites, 1 - a, face, matrixStack, vertexConsumerProvider, WorldRenderer.getLightmapCoordinates(world, occludingPos), overlay);
		//		} else if (divisionLevel ==2) {
		//			renderFront2(sprites, 1 - a, face, matrixStack, vertexConsumerProvider, WorldRenderer.getLightmapCoordinates(world, occludingPos), overlay);
		//		} else {
		//			renderFront4(sprites, 1 - a, face, matrixStack, vertexConsumerProvider, WorldRenderer.getLightmapCoordinates(world, occludingPos), overlay);
		//		}
		//
