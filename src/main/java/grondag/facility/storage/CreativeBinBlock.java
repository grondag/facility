...
public class CreativeBinBlock extends CrateBlock implements BlockAttackInteractionAware {
	protected final int divisionLevel;

	public CreativeBinBlock(Block.Settings settings, Supplier<BlockEntity> beFactory, int divisionLevel) {
